...
//	private FogDevice getFogNode()
//	{
//		for(FogDevice dev : getFogDevices())
//			if(dev.getName().startsWith("a"))
//				return dev;
//		return null;
//	}
...
private void printCostDetailsFog(){
		
		for(FogDevice fogDevice : getFogDevices()){
			System.out.println(fogDevice.getName() + " : Cost of execution = "+fogDevice.getTotalCost());
		}
	}
